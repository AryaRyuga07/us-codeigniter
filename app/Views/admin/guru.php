        ...
        <?php foreach ($guru as $g) : ?>
            <tbody>
                <tr class="bg-white dark:bg-gray-800">
                    ...
                    <td class="px-6 py-4">
                        <a href="#" data-modal-target="staticModal" data-modal-toggle="staticModal" class="font-medium text-blue-600 dark:text-blue-500 hover:underline tampilUbahModal" data-id="<?= $g['id_guru']; ?>">Edit</a>
                    </td>
                    <td class="px-6 py-4">
                        <a href="#" data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="font-medium text-red-600 dark:text-blue-500 hover:underline" data-id="<?= $g['id_guru']; ?>">Delete</a>
                    </td>
                </tr>
            </tbody>
        <?php endforeach ?>
...
<script>
    $(function() {
        ...
        $('.tampilUbahModal').on('click', function() {
            $('.modal-title').html('Ubah Data Guru');
        });
    });
</script>
